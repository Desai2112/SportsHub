  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="bg-gray-100 text-gray-800 py-8"
      >
        <div className="container mx-auto">
          <h1 className="text-3xl text-center mb-8 font-bold text-gray-900">Get in Touch</h1>
            ...
            >
              ...
              <form id="contact-form" onSubmit={handleSubmit(onSubmit)} noValidate>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-purple-500 text-gray-100 py-2 px-4 mt-4 rounded-md hover:bg-purple-600"
                  disabled={disabled}
                  type="submit"
                >
                  Submit
